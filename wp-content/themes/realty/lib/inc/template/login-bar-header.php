...
foreach( $template_page_user_profile_array as $template_page_user_profile ) {
	$template_page_user_profile = $template_page_user_profile->ID;
	break;
}
...
foreach( $template_page_user_favorites_array as $template_page_user_favorites ) {
	$template_page_user_favorites = $template_page_user_favorites->ID;
	break;
}	
...
foreach( $template_page_property_submit_listing_array as $template_page_property_submit_listing ) {
	$submit_listing_page = $template_page_property_submit_listing->ID;
	break;
}
?>
<div id="login-bar-header" class="primary-tooltips">
	...
	<?php } 
	// Theme Option: Hide Submit Link For Visitors?
	if ( !$realty_theme_option['site-header-hide-property-submit-link'] ) { 
	?>
	...
	if ( !empty( $get_user_meta_favorites ) ) {
