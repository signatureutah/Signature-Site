(function () {
	...
	tinymce.create("tinymce.plugins.tt_mce_button",
	{
        ...
        btn.onRenderMenu.add(function (c, b) {	
					...
					a.addImmediate( b, 'Property Listing', '[property_listing colums="3" per_page="10" location="london" status="rent" type="apartment" features="balcony" max_price="3000" min_rooms="3" available_from="20131231"]' );
