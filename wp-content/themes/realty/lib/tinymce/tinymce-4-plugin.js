		...
		editor.addButton( 'tt_mce_button', {
			...
			menu: [
				...
				
				{
					...
					onclick: function() {
								editor.insertContent('[property_listing colums="3" per_page="10" location="london" status="rent" type="apartment" features="balcony" max_price="3000" min_rooms="3" available_from="20131231"]');
							}
				},
